(function () {
  ...
  ProductsController.$inject = ['$scope', 'productResolve', '$stateParams', '$location', 'Authentication', 'Products', 'Categories', '$filter'];

  function ProductsController($scope, product, $stateParams, $location, Authentication, Products, Categories, $filter) {
    var vm = this;
